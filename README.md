...
Visual Studio project files and add it to your solution and link it with NNPACK. Don't use CMake for NNPACK itself under Windows because it will not without some changes provide you with a functional library. This is because the library mix AVX2 code ans psimd under windows and not on other operating systems.
